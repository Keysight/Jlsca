...
function recoverKey(params::AesSboxAttack, phaseInputOrig::AbstractVector{UInt8})
  mode = params.mode
  direction = params.direction
...
function getDataPass(params::AesSboxAttack, phase::Int, phaseInput::AbstractVector{UInt8})
